<div class="footer-left">
			...
			<div class="footer-center">
				...
				<p class="footer-links">
					<a href="#">Accueil</a> | <a href="nos_offres_emploi.php">Offres d'emploi</a> | <a href="depot_cv.php">D&eacute;p&ocirc;t de CV</a><br><a href="mentions_legales.php">Mentions l&eacute;gales</a> | <a href="contact.php">Contact</a>
				</p>
				...
				<p class="footer-company-name">Corhom BTP &copy; <? echo date("Y"); ?></p>
			...
			<div class="footer-right">
				...
				<div>
					<i class="fa fa-phone"></i>
					<p><span class="telephone">04 78 35 02 62</span></p>
				</div>
				<!--
